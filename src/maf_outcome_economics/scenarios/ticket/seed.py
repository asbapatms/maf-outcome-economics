...
FICTIONAL_TICKETS = [
    ...
    Ticket(
        id="TKT-021",
        subject="Payroll integration rejects approved timesheets",
        description="A fictional payroll connector rejects valid approved timesheets.",
        gold_category="Integration",
        gold_priority="P2",
        gold_resolver_group="Enterprise Integration",
    ),
    Ticket(
        id="TKT-022",
        subject="Payment gateway returns duplicate authorizations",
        description="A fictional payment gateway creates duplicate card authorizations.",
    ...
    Ticket(
        id="TKT-023",
        subject="Knowledge article links redirect incorrectly",
        description="A fictional help center sends users to outdated article locations.",
        gold_category="Knowledge management",
        gold_priority="P4",
        gold_resolver_group="Content Operations",
    ),
    Ticket(
        id="TKT-024",
        subject="Warehouse scanner loses wireless connection",
        description="A fictional handheld scanner disconnects during inventory counts.",
        gold_category="Network",
        gold_priority="P2",
        gold_resolver_group="Warehouse Technology",
    ),
    Ticket(
        id="TKT-025",
        subject="Credential rotation failed for service account",
        description="A fictional production service account retained an expired credential.",
        gold_category="Identity and access",
        gold_priority="P1",
        gold_resolver_group="Identity Operations",
    ),
    Ticket(
        id="TKT-026",
        subject="Customer survey responses are not imported",
        description="A fictional experience platform has not imported recent survey responses.",
        gold_category="Data pipeline",
        gold_priority="P3",
        gold_resolver_group="Customer Data Platform",
    ),
    Ticket(
        id="TKT-027",
        subject="Conference room display remains offline",
        description="A fictional meeting room display cannot connect to the conferencing service.",
        gold_category="Collaboration",
        gold_priority="P4",
        gold_resolver_group="Workplace Technology",
    ),
    Ticket(
        id="TKT-028",
        subject="Privacy export contains incomplete account history",
        description="A fictional privacy request export omits part of the account history.",
        gold_category="Privacy",
        gold_priority="P1",
        gold_resolver_group="Privacy Operations",
    ),
    Ticket(
        id="TKT-029",
        subject="Order fulfillment queue is processing slowly",
        description="A fictional fulfillment queue is delaying standard customer orders.",
        gold_category="Performance",
        gold_priority="P2",
        gold_resolver_group="Commerce Reliability",
    ),
    Ticket(
        id="TKT-030",
        subject="Development environment quota is exhausted",
        description="A fictional engineering team cannot create another development environment.",
        gold_category="Capacity",
        gold_priority="P3",
        gold_resolver_group="Developer Platform",
    ),
    Ticket(
        id="TKT-031",
        subject="Security alert indicates impossible travel",
        description="A fictional identity security alert reports impossible user travel.",
        gold_category="Security",
        gold_priority="P1",
        gold_resolver_group="Security Operations",
    ),
    Ticket(
        id="TKT-032",
        subject="Training portal completion status is delayed",
        description="A fictional learning portal has not recorded recent course completions.",
        gold_category="Application",
        gold_priority="P4",
        gold_resolver_group="Business Applications",
    ),
